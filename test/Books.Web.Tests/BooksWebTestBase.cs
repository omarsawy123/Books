...
{
    public abstract class BooksWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BooksWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BooksWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BooksDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BooksDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BooksDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BooksDbContext, Task<T>> func)
        {
            T result;
