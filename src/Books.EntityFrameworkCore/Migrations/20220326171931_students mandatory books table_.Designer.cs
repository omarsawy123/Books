...
namespace Books.Migrations
{
    ...
    [Migration("20220326171931_students mandatory books table_")]
    partial class studentsmandatorybookstable_
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Books.Administration.AcademicGradeBooks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AcademicGradeBooks");
                });

            modelBuilder.Entity("Books.Administration.AcademicGradeClasses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AcademicGradeClasses");
                });

            modelBuilder.Entity("Books.Administration.AcademicStudents", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AcademicStudents");
                });

            modelBuilder.Entity("Books.Administration.AcademicYears", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Books.Administration.Classes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Books.Administration.Grades", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Books.Administration.StudentBooks", b =>
                {
                    ...
                    b.Property<bool>("IsPreviousYear")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Books.Administration.StudentSelectedBooks", b =>
                {
                    ...
                    b.ToTable("StudentSelectedBooks");
                });

            modelBuilder.Entity("Books.Administration.Students", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Books.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Books.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Books.Administration.AcademicGradeBooks", b =>
                {
                    b.HasOne("Books.Administration.AcademicYears", "AcademicYear")
                        .WithMany()
                        .HasForeignKey("AcademicYearId");

                    b.HasOne("Books.Administration.StudentBooks", "Book")
                        .WithMany()
                        .HasForeignKey("BookId");

                    b.HasOne("Books.Administration.Grades", "Grade")
                        .WithMany()
                        .HasForeignKey("GradeId");

                    b.HasOne("Books.Administration.Publishers", "Publisher")
                        .WithMany()
            ...
            modelBuilder.Entity("Books.Administration.AcademicGradeClasses", b =>
                {
                    ...
                    b.HasOne("Books.Administration.Classes", "Class")
                        .WithMany()
            ...
            modelBuilder.Entity("Books.Administration.AcademicStudents", b =>
                {
                    b.HasOne("Books.Administration.AcademicGradeClasses", "AcademicGradeClasses")
                    ...
                    b.Navigation("AcademicGradeClasses");
